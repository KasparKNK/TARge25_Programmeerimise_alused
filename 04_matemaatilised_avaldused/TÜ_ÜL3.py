...
def practice_addition(count: int, min_value: int, max_value: int) -> None:
    ...
    print(f"See oli viimane ülesanne. Kogusid {count}-ist punktist {correct_count}.")


if __name__ == '__main__':
    count = int(input("Mitu korda soovid harjutada? "))
    min_value = int(input("Milline peaks olena väikseim täisarv harjutuses? "))
    max_value = int(input("Milline peaks olena suurim täisarv harjutuses? "))
